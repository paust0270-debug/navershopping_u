...
const PRODUCT = {
  name: "차이팟",
  mid: "83539482665",
  keyword: "프리미엄 블루투스 이어팟 차이팟 무선이어폰 충전케이스무료",
  mall: "",
};

// 스케줄 재조정 (16:23 즉시 시작) + 23:45 추가 (2000회 달성용)
const CONFIG = {
  customSchedule: [
    { hour: 16, minute: 23 },   // 즉시 시작
    { hour: 17, minute: 45 },
    { hour: 19, minute: 15 },
    { hour: 20, minute: 45 },
    { hour: 22, minute: 15 },
    { hour: 23, minute: 45 },   // 추가 슬롯 (2000회 달성용)
  ],
  baseCount: 340,  // 340 × 6 = 2040회
  variance: 10,
  scriptPath: path.join(__dirname, "mass-rotation-runner.ts"),
  logDir: path.join(__dirname, "..", "logs", "chaipot"),
};
