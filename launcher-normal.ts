 ...
 * 3. 에러나면 재시작
 *
 * Normal PC 전용: D:\turafic 경로 사용
 *
 * 빌드: npx pkg launcher-normal.ts -t node18-win-x64 -o turafic-launcher-normal.exe
 */
